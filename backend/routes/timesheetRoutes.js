...
const { createUserEntry, getAllUsers, getUserEntries, updateAUsersEntry, deleteAUsersEntry, getAllUsersNotEntered } = require('../controllers/timeSheetController');
...
router.route('/admin/users').get(readAllUserTimesheetAuth, weekStartQuery, validation, getAllUsersNotEntered);
