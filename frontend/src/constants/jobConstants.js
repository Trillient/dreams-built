...
export const JOBPART_DUEDATES_UPDATE_REQUEST = 'JOBPART_DUEDATE_UPDATE_REQUEST';
export const JOBPART_DUEDATES_UPDATE_SUCCESS = 'JOBPART_DUEDATE_UPDATE_SUCCESS';
export const JOBPART_DUEDATES_UPDATE_FAIL = 'JOBPART_DUEDATE_UPDATE_FAIL';
